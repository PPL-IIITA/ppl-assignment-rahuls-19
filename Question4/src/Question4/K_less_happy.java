...
//       throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    K_less_happy(K_less_happy[] couples) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
	...
	public static void k_less_happy(K_less_happy[] couples, int n, int k)
	{
	...
	//The breakup function accepts an array of couples and the value entered by the user,k
	public final void breakup(K_less_happy[] couples, int n, int k)
	{
		int[] done = new int[200];

...
public class Breakup
{
	...
	K_less_happy[] couples = Arrays.initializeWithDefaultCoupleInstances(Constants.NO_OF_GIRLS);
    ...
    public final void giveGifts()
	{
            try {
                ...
                K_less_happy[] couples = Arrays.initializeWithDefaultCoupleInstances(100);
                
                Gift[] gifts = Arrays.initializeWithDefaultGiftInstances(200);
                FileReader fi = new FileReader("breakup.txt");
                BufferedReader couples_file = new BufferedReader(fi);
               
                System.out.print("Has created the breakup file\n");
